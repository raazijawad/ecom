...
use App\Filament\Resources\SegmentResource\Pages\ManageSegments;
...
class SegmentResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Segments / Tags';
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                TextColumn::make('subscribers_count')->counts('subscribers')->label('Subscribers')->sortable(),
