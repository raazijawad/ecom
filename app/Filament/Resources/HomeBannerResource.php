...
class HomeBannerResource extends Resource
{
    ...
    protected static string|null|\UnitEnum $navigationGroup = 'Advertisment';
    ...
    public static function form(Schema $schema): Schema
    {
        return $schema->components([
            Select::make('product_id')
                ...
                ->searchable()
                ->preload()
                ->helperText('Select a product to automatically use the product detail page image in the home banner.'),
            FileUpload::make('manual_image_path')
                ->label('Manual home banner image')
                ->disk('public')
                ->directory('home-banners')
                ->image()
                ->imageEditor()
                ->helperText('Optional: upload a custom image that overrides the selected product image.'),
